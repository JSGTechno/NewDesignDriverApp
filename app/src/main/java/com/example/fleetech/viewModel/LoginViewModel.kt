...
class   LoginViewModel : ViewModel() {
    ...
    fun getUserLoginData(mobileNo: String, otp: String, userType: String, ctx: Context, latitude: Double, longitude: Double, address: String) {
        RetrofitClient.retrofit = null
        val userAPI = Apiuitils.testUrl
        println("MObile No $mobileNo")
        loading.value = true
        val call = userAPI.verifyPWD(UpdateModel(mobileNo, otp, userType, latitude, longitude, address))
